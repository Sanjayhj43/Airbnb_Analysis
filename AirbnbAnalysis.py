...
st.set_page_config(page_title= "Airbnb Data Visualization | By Sanjay HJ",
                   #page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Sanjay HJ*!
...
client = pymongo.MongoClient("mongodb+srv://sanjayhj43:vQALk7iqNWcP1j97@cluster0.rdzsvwp.mongodb.net/?retryWrites=true&w=majority")
db = client.sample_airbnb
col = db.listingsAndReviews

# READING THE CLEANED DATAFRAME
df = pd.read_csv("C:\\Users\\sanja\\Airbnb_data.csv")
